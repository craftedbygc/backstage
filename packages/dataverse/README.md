...
```sh
$ npm install @unseenco/backstage/dataverse
# and the react bindings
$ npm install @unseenco/backstage/react
```
...
```tsx
import {useAtom} form '@unseenco/backstage/react'
...
```tsx
import {useVal, useAtom} from '@unseenco/backstage/react'
...
```ts
import {Ticker, onChange} from '@unseenco/backstage/dataverse'
