...
```sh
$ npm install @unseenco/theatre-dataverse
# and the react bindings
$ npm install @unseenco/theatre-react
```
...
```tsx
import {useAtom} form '@unseenco/theatre-react'
...
```tsx
import {useVal, useAtom} from '@unseenco/theatre-react'
...
```ts
import {Ticker, onChange} from '@unseenco/theatre-dataverse'
...
- Also see [`@unseenco/theatre-react`](../react/README.md) to learn more about the React
  bindings.
