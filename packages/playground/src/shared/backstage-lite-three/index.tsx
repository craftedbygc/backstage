...
import {
  autoAddCamera,
  autoAddObject,
} from '@unseenco/backstage/threejs?backstage-lite-peers'
...
const rafDriver = createRafDriver({name: 'backstage-lite-three'})
...
const project = getProject('Backstage Lite Three', {state})
