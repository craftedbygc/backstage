...
import Project from '@unseenco/backstage/projects/Project'
...
export type ISheetOptions = {
  ...
  /**
   * When `true`, enables the GSAP sequence bridge for this sheet (required for `@unseenco/backstage/gsap`).
   */
  gsap?: boolean
  /**
...
export interface IProject {
  /** Discriminator for Backstage.js public project instances. */
  readonly type: 'Backstage_Project_PublicAPI'
  /**
   * If `@unseenco/backstage/studio` is used, this promise would resolve when studio has loaded
...
export default class BackstageProject implements IProject {
  get type(): 'Backstage_Project_PublicAPI' {
    return 'Backstage_Project_PublicAPI'
  }
  /**
   * @internal
   */
