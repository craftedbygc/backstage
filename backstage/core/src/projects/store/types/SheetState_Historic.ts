...
export type Keyframe = {
  ...
  // defaults to 'bezier' to support project states made with backstage0.5.1 or earlier
  type?: KeyframeType
  /**
...
/**
 * A GSAP tween segment on the Backstage sequence timeline, bridged at runtime
 * via `@unseenco/backstage/gsap`.
 */
