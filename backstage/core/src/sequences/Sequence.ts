...
import {pointer} from '@unseenco/backstage/dataverse'
...
import BackstageSequence from './BackstageSequence'
import {
...
export default class Sequence implements PointerToPrismProvider {
  ...
  constructor(
    ...
    this.publicApi = new BackstageSequence(this)
...
To fix this, either set \`conf.range[1]\` to be less the duration of the sequence, or adjust the sequence duration in the UI.`,
          [
            {
              url: 'https://backstage.unseen.co/docs/guide/manual/sequences',
              title: 'Sequences',
            },
            {
              url: 'https://backstage.unseen.co/docs/guide/manual/sequences',
