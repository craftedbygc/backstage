...
import type {
  ...
  Prism,
  Pointer,
} from '@unseenco/backstage/dataverse'
...
import BackstageSheetObject from './BackstageSheetObject'
...
export default class SheetObject implements PointerToPrismProvider {
  get type(): 'Backstage_SheetObject' {
    return 'Backstage_SheetObject'
  }
  readonly $$isPointerToPrismProvider: true = true
  readonly address: SheetObjectAddress
  readonly publicApi: BackstageSheetObject
  ...
  constructor(
    ...
    this.publicApi = new BackstageSheetObject(this)
  }
   ...
   * merged value (identical to what `BackstageSheetObject.onValuesChange()`
