...
} from '@unseenco/backstage/sheets/BackstageSheet'
...
import {Atom, getPointerParts, prism, val} from '@unseenco/backstage/dataverse'
...
import type {SheetAhistoricState} from '@unseenco/backstage/projects/store/storeTypes'
import {
...
} from '@unseenco/backstage/sequences/sequenceVariants'
...
import type {UnknownShorthandCompoundProps} from '@unseenco/backstage/propTypes/internals'
import {compound, compoundFromSanitizedProps} from '@unseenco/backstage/propTypes'
...
export default class SheetObjectTemplate {
  ...
  readonly type: 'Backstage_SheetObjectTemplate' = 'Backstage_SheetObjectTemplate'
