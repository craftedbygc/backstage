 ...
 *   BACKSTAGE_LITE_TEST=1 yarn test backstage/core/src/backstageLite.test.ts
 */
...
const describeLite =
  process.env.BACKSTAGE_LITE_TEST === '1' ? describe : describe.skip

describeLite('@unseenco/backstage/core-lite value resolution', () => {
