...
import LiteSequence from '@unseenco/backstage/sequences/LiteSequence'
...
import BackstageSheet from '@unseenco/backstage/sheets/BackstageSheet'
import type {SheetAddress} from '@unseenco/backstage-shared/utils/addresses'
import {Atom, prism, val} from '@unseenco/backstage/dataverse'
...
export default class Sheet {
  ...
  readonly publicApi: BackstageSheet
  readonly project: Project
  readonly objectsP = this._objects.pointer
  type: 'Backstage_Sheet' = 'Backstage_Sheet'
  ...
  constructor(
    ...
    this.publicApi = new BackstageSheet(this)
