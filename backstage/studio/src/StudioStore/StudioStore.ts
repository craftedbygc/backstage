import type {FullStudioState} from '@unseenco/backstage/studio/store'
import {
  studioActions,
  studioReducer,
  tempActionGroup,
} from '@unseenco/backstage/studio/store'
import type {IStateEditors} from '@unseenco/backstage/studio/store/stateEditors'
import {setDrafts__onlyMeantToBeCalledByTransaction} from '@unseenco/backstage/studio/store/stateEditors'
import type {
  StudioAhistoricState,
  StudioEphemeralState,
  StudioHistoricState,
} from '@unseenco/backstage/studio/store/types'
import type {Deferred} from '@unseenco/backstage-shared/utils/defer'
import {defer} from '@unseenco/backstage-shared/utils/defer'
import atomFromReduxStore from '@unseenco/backstage/studio/utils/redux/atomFromReduxStore'
import configureStore from '@unseenco/backstage/studio/utils/redux/configureStore'
...
export default class StudioStore {
  ...
  constructor() {
    this._reduxStore = configureStore({
      ...
      devtoolsOptions: {name: 'Backstage.js Studio'},
    })
