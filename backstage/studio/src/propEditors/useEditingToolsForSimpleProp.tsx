...
import type Scrub from '@unseenco/backstage/studio/Scrub'
...
import type {PropTypeConfig_AllSimples} from '@unseenco/backstage/propTypes'
...
function createPrism<T extends SerializablePrimitive>(
  ...
  return prism(() => {
    ...
    const isSequencable =
      isPropConfSequencable(propConfig) && !isBackstageLiteStudio()
