import type {SequenceEditorTree_AllRowTypes} from '@unseenco/backstage/studio/panels/SequenceEditorPanel/layout/tree'
import {useDomElementHighlight} from '@unseenco/backstage/studio/gsap/useDomElementHighlight'
import {
  isGsapSequencerHighlightRow,
  resolveGsapSequencerRowHighlightElement,
} from '@unseenco/backstage/studio/gsap/resolveGsapSequencerRowHighlightElement'
