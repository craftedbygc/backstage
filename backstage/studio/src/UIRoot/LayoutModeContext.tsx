...
import type {DockedLayoutSizes} from '@unseenco/backstage/studio/store/types/historic'
import {notifyDockedToggle} from '@unseenco/backstage/studio/UI/dockedViewport'
...
export const LayoutModeProvider: React.FC<{
  ...
  const pinSequenceEditor = isBackstageLiteStudio()
    ? false
