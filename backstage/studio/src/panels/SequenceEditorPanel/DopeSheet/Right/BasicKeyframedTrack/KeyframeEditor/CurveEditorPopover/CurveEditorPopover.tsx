import {Atom, prism} from '@unseenco/backstage/dataverse'
...
import type {KeyframeConnectionWithAddress} from '@unseenco/backstage/studio/panels/SequenceEditorPanel/DopeSheet/selections'
