...
import type {AggregateKeyframePositionIsSelected} from '@unseenco/backstage/studio/panels/SequenceEditorPanel/DopeSheet/Right/AggregatedKeyframeTrack/AggregatedKeyframeTrack'
