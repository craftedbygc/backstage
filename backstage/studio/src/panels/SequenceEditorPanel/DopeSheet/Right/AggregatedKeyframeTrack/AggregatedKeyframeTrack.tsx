...
import {collectSheetObjectsFromSheetChildren} from '@unseenco/backstage/studio/panels/SequenceEditorPanel/layout/tree'
import {isSequenceEditorSheetScopedAggregateViewModel} from '@unseenco/backstage/studio/panels/SequenceEditorPanel/layout/sequenceEditorAggregateViewModel'
import {usePrism, useVal} from '@unseenco/backstage/react'
import type {Prism, Pointer} from '@unseenco/backstage/dataverse'
import {prism, val, pointerToPrism} from '@unseenco/backstage/dataverse'
...
import type {
  AggregatedKeyframes,
  KeyframeWithTrack,
} from '@unseenco/backstage/studio/panels/SequenceEditorPanel/DopeSheet/Right/collectAggregateKeyframes'
import {
