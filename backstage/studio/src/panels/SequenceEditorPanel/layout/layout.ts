...
import type useDrag from '@unseenco/backstage/studio/uiComponents/useDrag'
import type {SheetAddress} from '@unseenco/backstage-shared/utils/addresses'
import subPrism from '@unseenco/backstage-shared/utils/subPrism'
import type {
  IRange,
...
} from '@unseenco/backstage/studio/panels/SequenceEditorPanel/PlaybackControls/sequenceZoom'
...
export type SequenceEditorPanelLayoutOptions = {
  isDocked: boolean
}
...
export function sequenceEditorPanelLayout(
  ...
  layoutOptions: SequenceEditorPanelLayoutOptions,
