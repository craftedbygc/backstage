...
import {getAllPossibleAssetIDs} from '@unseenco/backstage-shared/utils/assets'
...
const ProjectDetails: React.FC<{
  ...
  // e.g. `Butterfly.backstage-project-state.json`
  const suggestedFileName = `${slugifiedProjectId}.backstage-project-state.json`
