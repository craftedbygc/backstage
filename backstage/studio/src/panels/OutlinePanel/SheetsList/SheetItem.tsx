...
import {VariantItem} from '@unseenco/backstage/studio/panels/OutlinePanel/SheetsList/VariantItem'
import {
  shouldShowSequenceVariantsInOutline,
  useCollapseStateInOutlinePanel,
} from '@unseenco/backstage/studio/panels/OutlinePanel/outlinePanelUtils'
      ...
      <BaseItem
        ...
        selectionStatus={
          selection.some((s) => s === sheet)
            ? 'selected'
            : selection.some(
                (s) => s.type === 'Backstage_SheetObject' && s.sheet === sheet,
              )
