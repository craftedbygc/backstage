...
import type {
  DragHandlers,
  DragOpts,
} from '@unseenco/backstage/studio/uiComponents/useDrag'
import {
  DRAG_DETECTION_DISTANCE_THRESHOLD,
  MouseButton,
  didPointerLockCauseMovement,
} from '@unseenco/backstage/studio/uiComponents/useDrag'
import {isSafari} from '@unseenco/backstage/studio/uiComponents/isSafari'
import type {CapturedPointer} from '@unseenco/backstage/studio/UIRoot/PointerCapturing'
import {createPointerCapturing} from '@unseenco/backstage/studio/UIRoot/PointerCapturing'
...
>((t) => {
  ...
  function handleMouseup(
    ...
    // of the drag.
    // Fixes https://linear.app/backstage/issue/P-177/beginners-scrubbing-the-playhead-from-within-an-iframe-then-[space]
    window.focus()
