...
Reference-style guides for authoring with Backstage Studio and `@unseenco/backstage`.
...
- [Audio](./audio.md)
- [Studio](./studio.md)
- [Keyboard & mouse](./keyboard-shortcuts.md)
- [Runtime lifecycle](./runtime-lifecycle.md)
- [Authoring extensions](./authoring-extensions.md)
- [Advanced](./advanced.md)

API signatures and exhaustive option lists: [API reference](/api/).
